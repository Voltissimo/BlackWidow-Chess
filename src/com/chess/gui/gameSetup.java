...
class GameSetup extends JDialog {
    ...
    GameSetup(final JFrame frame,
        ...
        /*whiteComputerButton.setSelected(true);*/  // this messes up everything
        ...
        this.searchDepthSpinner = addLabeledSpinner(myPanel, new SpinnerNumberModel(4, 0, Integer.MAX_VALUE, 1));
        ...
        cancelButton.addActionListener(e -> GameSetup.this.setVisible(false));
